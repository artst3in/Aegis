...
> LunaOS · Aegis · LunaGlass · all future components.
>
...
println!("cargo:rustc-env=BUILD_DNA={}", iso8601_timestamp);
println!("cargo:rustc-env=APP_VERSION={}.{:02}", year, month);
```
...
pub const BUILD_DNA: &str = env!("BUILD_DNA");           // Nanosecond timestamp
